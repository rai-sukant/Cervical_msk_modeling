...
%%orientationsFileName = '_our_+_org_MT_012005D6_009-001_orientations.sto';   % The path to orientation data for calibration 
orientationsFileName = 'l_comf_01-000_00_orientations.sto';   % The path to orientation data for calibration 
...
startTime = 1;          % Start time (in seconds) of the tracking simulation. 
endTime = 60 ;              % End time (in seconds) of the tracking simulation.
